...
const SLIDES_CAPTURAS = [
  ...
  },
  {
    ...
    imagen: "https://res.cloudinary.com/dl1pgzshh/image/upload/v1781500837/7.png", 
    emoji: "🍕",
    bg: "#220505"
  },
  {
    ...
    imagen: "https://res.cloudinary.com/dl1pgzshh/image/upload/v1781500837/8.png", 
    emoji: "🛒",
    bg: "#190404"
  },
  {
    ...
    imagen: "https://res.cloudinary.com/dl1pgzshh/image/upload/v1781500837/9.png", 
    emoji: "🛵",
    bg: "#2d0808"
  },
  {
    ...
    imagen: "https://res.cloudinary.com/dl1pgzshh/image/upload/v1781500837/10.png", 
    emoji: "💬",
    bg: "#3c0b0b"
  }
];
...
export default function AppRed() {
  ...
  return (
    <div className="landing-container">
      ...
      <section className="hero-section">
        <div className="container" style={{ position: 'relative', zIndex: 5 }}>
          ...
          <h1 style={{ color: '#ffffff', fontSize: 'clamp(2.5rem, 5vw, 4.5rem)', lineHeight: '1.1', marginBottom: '24px', letterSpacing: '-0.03em' }}>
            ...
            <span style={{ color: '#ef4444' }}>como una App en tu Celular</span>
          </h1>

          <p style={{ color: '#fecdd3', fontSize: 'clamp(1.1rem, 2vw, 1.35rem)', maxWidth: '800px', margin: '0 auto 40px auto', fontWeight: '400', lineHeight: '1.6' }}>
          ...
          <div className="hero-carousel-container">
                ...
                <div className="hero-carousel-screen">
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                    {activeSlide === 0 && (
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                        <div style={{ background: 'linear-gradient(135deg, var(--primary) 0%, #3a0707 100%)', color: '#fff', padding: '36px 12px 12px 12px', textAlign: 'left' }}>
                          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.7rem', color: '#fecdd3', marginBottom: '4px' }}>
                            <span>🟢 Abierto</span>
                            <span>1:00 PM - 10:00 PM</span>
                          </div>
                          <h4 style={{ fontSize: '1.1rem', margin: 0 }}>Punto Pizza 🍕</h4>
                          <p style={{ fontSize: '0.65rem', margin: 0, color: '#fecdd3' }}>Menú de la Casa</p>
                        </div>
                        <div style={{ display: 'flex', gap: '6px', padding: '8px 12px', background: 'rgba(255,255,255,0.03)', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                          ...
                          <span style={{ fontSize: '0.7rem', padding: '4px 8px', borderRadius: '6px', background: 'rgba(255,255,255,0.05)', color: '#fecdd3' }}>Bebidas</span>
                        </div>
                        <div style={{ padding: '12px', display: 'flex', flexDirection: 'column', gap: '8px', flex: 1, textAlign: 'left' }}>
                          <div style={{ display: 'flex', gap: '8px', padding: '8px', background: 'rgba(255,255,255,0.02)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.04)' }}>
                            ...
                            <div style={{ flex: 1 }}>
                              ...
                              <p style={{ fontSize: '0.6rem', color: '#fecdd3', margin: '2px 0' }}>Queso mozzarella y pepperoni.</p>
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                <span style={{ fontSize: '0.8rem', color: '#f87171', fontWeight: '700' }}>S/ 35.00</span>
                        ...
                        <div style={{ padding: '8px 12px', background: 'rgba(25, 4, 4, 0.9)', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                      ...
                      <div style={{ padding: '36px 12px 12px 12px', textAlign: 'left', display: 'flex', flexDirection: 'column', height: '100%' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', background: 'rgba(255,255,255,0.02)', padding: '10px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.04)', marginBottom: '12px', flex: 1 }}>
                          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.75rem' }}>
                            ...
                            <span style={{ color: '#f87171' }}>S/ 35.00</span>
                          </div>
                        ...
                        <div style={{ background: 'rgba(255,255,255,0.02)', padding: '10px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.04)', fontSize: '0.65rem', display: 'flex', flexDirection: 'column', gap: '6px', marginBottom: '16px' }}>
                          <div style={{ fontWeight: '700', color: '#fecdd3' }}>🛵 Método de Entrega (Configurable)</div>
                          <div style={{ display: 'flex', gap: '4px' }}>
                            ...
                            <span style={{ flex: 1, padding: '4px 2px', background: 'rgba(255,255,255,0.05)', color: '#fecdd3', textAlign: 'center', borderRadius: '4px', fontSize: '0.6rem' }}>Llevar</span>
                            <span style={{ flex: 1, padding: '4px 2px', background: 'rgba(255,255,255,0.05)', color: '#fecdd3', textAlign: 'center', borderRadius: '4px', fontSize: '0.6rem' }}>Mesa</span>
                          </div>
                        </div>
                        <div style={{ background: '#ef4444', color: '#fff', padding: '10px', borderRadius: '10px', fontSize: '0.75rem', fontWeight: '700', textAlign: 'center' }}>
                      ...
                      <div style={{ padding: '36px 12px 12px 12px', textAlign: 'left', display: 'flex', flexDirection: 'column', height: '100%' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(255,255,255,0.08)', paddingBottom: '8px', marginBottom: '12px' }}>
                          <span style={{ fontSize: '0.8rem', fontWeight: '700', display: 'flex', alignItems: 'center', gap: '4px' }}>
                            <ChefHat size={12} color="#f87171" />
                            Admin Panel
                          </span>
                          <span style={{ fontSize: '0.55rem', background: '#991b1b', padding: '2px 4px', borderRadius: '4px' }}>Móvil</span>
                        </div>
                        <div style={{ background: 'rgba(255,255,255,0.02)', padding: '8px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.04)', marginBottom: '12px' }}>
                          <div style={{ fontSize: '0.55rem', color: '#fecdd3' }}>Ventas del Día</div>
                          <div style={{ fontSize: '1rem', fontWeight: '800', color: '#f87171' }}>S/ 582.00</div>
                        </div>
                        <div style={{ fontSize: '0.7rem', fontWeight: '700', marginBottom: '6px', color: '#fecdd3' }}>Pedidos Pendientes</div>
                    ...
                    {activeSlide === 4 && (
                      ...
                      <div style={{ padding: '36px 12px 12px 12px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', textAlign: 'center', height: '100%' }}>
                        <div style={{
                          ...
                          fontSize: '2.2rem',
                          boxShadow: '0 8px 20px rgba(153, 27, 27, 0.4)',
                          marginBottom: '16px'
                        }}>
                          🍕
                        </div>
                        <h4 style={{ fontSize: '1rem', marginBottom: '4px' }}>Punto Pizza App</h4>
                        <p style={{ fontSize: '0.65rem', color: '#fecdd3', padding: '0 8px', marginBottom: '16px' }}>
                        ...
                        <div style={{
                          ...
                          <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', fontWeight: '700', marginTop: '6px' }}>
                            ...
                            <span style={{ color: '#f87171', fontSize: '0.6rem' }}>Instalar</span>
                          </div>
                        </div>
                      </div>
                    )}
            ...
            <div style={{ marginTop: '16px', textAlign: 'center', maxWidth: '300px' }}>
              ...
              <p style={{ fontSize: '0.85rem', color: '#fecdd3', margin: 0, lineHeight: '1.4' }}>
          ...
          <div className="metrics-container">
            <div className="metric-item">
              <h3 style={{ color: '#f87171', fontSize: '2rem', marginBottom: '4px' }}>S/ 9.00</h3>
              <p style={{ color: '#fecdd3', fontSize: '0.9rem' }}>Precio fijo al mes</p>
            </div>
            <div className="metric-item">
              <h3 style={{ color: '#ffffff', fontSize: '2rem', marginBottom: '4px' }}>Instalable PWA</h3>
              <p style={{ color: '#fecdd3', fontSize: '0.9rem' }}>Funciona como App Móvil</p>
            </div>
            <div className="metric-item">
              <h3 style={{ color: '#ffffff', fontSize: '2rem', marginBottom: '4px' }}>Comisiones 0%</h3>
              <p style={{ color: '#fecdd3', fontSize: '0.9rem' }}>Venta directa a ti</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* VIDEO DEMO SECTION */}
      <section id="video-demo" className="section-padding" style={{ background: '#0c0202', borderTop: '1px solid rgba(248, 113, 113, 0.1)', borderBottom: '1px solid rgba(248, 113, 113, 0.1)' }}>
        <div className="container" style={{ maxWidth: '900px', textAlign: 'center' }}>
          ...
          <p style={{ color: '#fecdd3', fontSize: '1.1rem', marginBottom: '40px', maxWidth: '600px', margin: '0 auto 40px auto' }}>
          ...
          <div 
            ...
            style={{
              ...
              overflow: 'hidden',
              borderRadius: '16px',
              boxShadow: '0 20px 40px rgba(0, 0, 0, 0.5), 0 0 25px rgba(248, 113, 113, 0.15)',
      ...
      <section id="capturas" className="section-padding section-light-green">
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 48px auto' }}>
            ...
            <p style={{ color: '#fecdd3', marginTop: '16px', fontSize: '1.1rem' }}>
          ...
          <div className="phone-gallery-wrapper" style={{ display: 'flex', flexWrap: 'wrap', gap: '32px', justifyContent: 'center', marginTop: '60px' }}>
            {[
              {
                src: "https://res.cloudinary.com/dl1pgzshh/image/upload/v1781500837/6.png",
                label: "1. Categorías y Banner 🏷️"
              },
              {
                src: "https://res.cloudinary.com/dl1pgzshh/image/upload/v1781500837/7.png",
                label: "2. El Menú (Extras y Tamaños) 🍕"
              },
              {
                src: "https://res.cloudinary.com/dl1pgzshh/image/upload/v1781500837/8.png",
                label: "3. Añadir al Carrito 🛒"
              },
              {
                src: "https://res.cloudinary.com/dl1pgzshh/image/upload/v1781500837/9.png",
                label: "4. Carrito de Pedidos 🛵"
              },
              {
                src: "https://res.cloudinary.com/dl1pgzshh/image/upload/v1781500837/10.png",
      ...
      <section id="demo-qr" className="section-padding" style={{ background: '#0c0202', borderTop: '1px solid rgba(248, 113, 113, 0.1)', borderBottom: '1px solid rgba(248, 113, 113, 0.1)' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <img 
                  src="https://res.cloudinary.com/dl1pgzshh/image/upload/v1781501212/QR-Yomi_homi.png" 
              ...
              <span style={{ fontSize: '0.85rem', color: '#fecdd3', fontWeight: '500', display: 'flex', alignItems: 'center', gap: '6px' }}>
            ...
            <div style={{
              ...
              <p style={{ color: '#fecdd3', fontSize: '1.05rem', lineHeight: '1.6', margin: 0 }}>
              ...
              <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap', marginTop: '10px' }}>
                <a 
                  href="https://cartadigital.site/yomi-homi" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="btn-primary animate-pulse-glow"
        ...
        <div className="container">
          ...
          <div className="features-grid">
            <div className="glass-card">
              <div style={{ width: '48px', height: '48px', borderRadius: '12px', backgroundColor: 'rgba(239,68,68,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '24px' }}>
                <Smartphone color="#f87171" size={24} />
              </div>
            ...
            <div className="glass-card">
              <div style={{ width: '48px', height: '48px', borderRadius: '12px', backgroundColor: 'rgba(239,68,68,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '24px' }}>
                <MessageSquare color="#f87171" size={24} />
              </div>
            ...
            <div className="glass-card">
              <div style={{ width: '48px', height: '48px', borderRadius: '12px', backgroundColor: 'rgba(239,68,68,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '24px' }}>
                <TrendingUp color="#f87171" size={24} />
              </div>
        ...
        <div className="container">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '32px', alignItems: 'center' }}>
            ...
            <div className="pricing-card">
              ...
              <p style={{ color: '#fecdd3', fontSize: '0.95rem', marginBottom: '32px' }}>Pedidos y platos ilimitados para tu WhatsApp</p>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'baseline', marginBottom: '12px' }}>
                ...
                <span style={{ fontSize: '5.5rem', fontWeight: '900', color: '#f87171', lineHeight: '1', fontFamily: 'var(--font-heading)' }}>9</span>
                <span style={{ fontSize: '1.25rem', color: '#fecdd3', marginLeft: '8px' }}>/ mes</span>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', textAlign: 'left', maxWidth: '360px', margin: '0 auto 40px auto', borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: '32px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <CheckCircle2 size={20} color="#f87171" style={{ flexShrink: 0 }} />
              ...
              <div style={{ display: 'flex', gap: '8px', alignItems: 'center', justifyContent: 'center', marginTop: '24px', color: '#fecdd3', fontSize: '0.85rem' }}>
                <AlertCircle size={16} />
      ...
      <section className="section-padding section-light-green">
        <div className="container" style={{ maxWidth: '800px' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <p style={{ color: '#fecdd3', marginTop: '8px' }}>Todo lo que necesitas saber antes de empezar</p>
          </div>
            ...
            {faqs.map((faq, index) => {
              ...
              return (
                <div key={index} className="faq-item">
                  ...
                  >
                    <span>{faq.q}</span>
                    {isOpen ? <ChevronUp size={20} color="#f87171" /> : <ChevronDown size={20} color="#cbd5e1" />}
                  </div>
                  {isOpen && (
